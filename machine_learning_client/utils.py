...
#         energy = sum(abs(b - 128) for b in frames) / len(frames)
#         classification = "speech" if energy > 20 else "silence"

#     return {"classification": classification, "energy": round(energy, 2)}
...
#         for keyword in KEYWORD_EMOTION_MAP:
#             if keyword in word:
#                 return KEYWORD_EMOTION_MAP[keyword]
#     return "neutral"
